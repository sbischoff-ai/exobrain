...
class Settings(BaseSettings):
    ...
    auth_session_introspection_enabled: bool = Field(default=False, alias="AUTH_SESSION_INTROSPECTION_ENABLED")
    auth_session_header_name: str = Field(default="x-session-id", alias="AUTH_SESSION_HEADER_NAME")
    auth_session_redis_url: str = Field(default="redis://localhost:16379/0", alias="AUTH_SESSION_REDIS_URL")
    auth_session_redis_key_prefix: str = Field(default="assistant:sessions", alias="AUTH_SESSION_REDIS_KEY_PREFIX")
