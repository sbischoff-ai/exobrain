...
from app.adapters.web_tools import StaticWebSearchClient, WebSearchAdapter
...
def create_app() -> FastAPI:
    ...
    tool_service = ToolService(registry=ToolAdapterRegistry(web_search_adapter=web_search_adapter))
