...
- Knowledge content blocks support local edit mode with an in-editor lower-right `Save changes` action that exits editing and keeps the edited markdown for subsequent rendered mode without network persistence.
