...
impl KnowledgeApplication {
    ...
    pub async fn find_entity_candidates(
        ...
        candidate_search::find_entity_candidates(self, query).await
    }
    ...
    pub async fn list_entities_by_type(
        ...
        entity_listing::list_entities_by_type(self, query).await
    }
    ...
    pub async fn get_entity_context(
        ...
        entity_context::get_entity_context(self, query).await
    }
    ...
    async fn upsert_graph_delta_internal(&self, delta: GraphDelta) -> Result<()> {
        ingestion::upsert_graph_delta_internal(self, delta).await
    }
