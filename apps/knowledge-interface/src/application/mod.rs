...
impl KnowledgeApplication {
    ...
    pub async fn find_node_type_candidates(
        ...
        use_cases::type_search::find_type_candidates(self, SchemaKind::Node, query).await
    }
    ...
    pub async fn find_edge_type_candidates(
        ...
        use_cases::type_search::find_type_candidates(self, SchemaKind::Edge, query).await
    }
