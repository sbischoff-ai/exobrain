...
- `MODEL_PROVIDER_BASE_URL` (default: `http://localhost:8010/v1`, model-provider endpoint used by step-three extraction and step-four routing agents via the internal `ModelProviderChatModel` contract for tool calling and structured output)
