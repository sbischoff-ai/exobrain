...
VALUES
    ('11111111-1111-1111-1111-111111111111', 'Test User', 'test.user@exobrain.local'),
    ('77777777-7777-7777-7777-777777777777', 'Architect User', 'architect@exobrain.local')
ON CONFLICT (email)
